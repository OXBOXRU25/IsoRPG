...
namespace IsoRPG.EditorTools
{
    ...
    public static class PackCatalog
    {
        ...
        public static readonly Entry[] All =
        {
            ...
            // Лошадей сюда НЕ добавлять — проверено 31.08.2026 и стоило
            // отката.
            //
            // Материалы Malbers сидят на собственных шейдерах (`Malbers/Color4x4`
            // и родня), которые красят модель НАБОРОМ ЦВЕТОВ, а не текстурой.
            // Общая починка видит «не Universal» и переводит их на Lit —
            // цвета при этом переносить некуда, и вся конюшня становится
            // белой. В игре до починки лошадь была нормальной, коричневой:
            // набор свежий и в Universal работает сам.
            //
            // Восстанавливается только переимпортом:
            //   node tools/import-unitypackage.mjs "H:\2\Лошадь\Horse Animset Pro Riding System.unitypackage"
        };
