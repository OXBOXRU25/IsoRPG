...
namespace IsoRPG.Player
{
    ...
    public sealed class CharacterAnimatorDriver : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Вдвое, а не втрое.
            //
            // Втрое я поставил, чтобы убрать скольжение после касания, и
            // перестарался: Павлон 04.09.2026 «слишком ускорил, стало прям
            // мигание». Присед с разгибанием — движение читаемое, и на
            // тройной скорости оно перестаёт быть движением. Скольжение
            // лечим не темпом клипа, а смещением его начала (cycleOffset).
