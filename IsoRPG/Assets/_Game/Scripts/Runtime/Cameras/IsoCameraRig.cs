...
namespace IsoRPG.Cameras
{
    ...
    public sealed class IsoCameraRig : MonoBehaviour
    {
        ...
        ///
        /// Отсчитывается от самого близкого деления вверх: на упоре героя нет
        /// совсем, за 0.6 выше он уже целый. Меньше — растворение читается
        /// как мигание, больше — герой начинает таять на обычном игровом
        /// расстоянии, где он нужен целым.
        /// </summary>
        private const float FadeZoomSpan = 0.6f;
