...
namespace IsoRPG.Items
{
    ...
    public enum EquipSlot
    {
        ...
        // Ниже — слоты, добавленные 01.09.2026 под набор иконок Павлона.
        // Дописаны В КОНЕЦ намеренно: значения перечисления хранятся в
        // ассетах предметов числами, и вставка в середину переназначила
        // бы слот каждой уже созданной вещи.

        /// <summary>Наплечники.</summary>
        Shoulders,

        /// <summary>Наручи, они же запястья.</summary>
        Wrists,

        /// <summary>Пояс.</summary>
        Waist,

        /// <summary>Колчан и прочий боезапас.</summary>
        Ammo,
