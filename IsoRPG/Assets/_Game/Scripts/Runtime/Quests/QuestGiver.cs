...
namespace IsoRPG.Quests
{
    ...
    public sealed class QuestGiver : MonoBehaviour
    {
        ...
        private void Update()
        {
            // Слежение за игроком убрано 01.09.2026 по решению Павла: это
            // ММО, и к одному НПС подойдут двое — за кем ему поворачиваться?
            // Стоит статично, как поставил его дизайнер. Метод оставлен:
            // он ещё пригодится в диалоге один на один.
