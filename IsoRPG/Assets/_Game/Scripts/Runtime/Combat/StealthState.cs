...
namespace IsoRPG.Combat
{
    ...
    public sealed class StealthState : MonoBehaviour
    {
        ...
        /// </summary>
        /// <summary>
        /// Переприменить прозрачность.
        ///
        /// Нужен тому, кто перезаписывает материалы персонажа — силуэту
        /// сквозь стены. Он возвращает исходные материалы, и вместе с ними
        /// возвращается непрозрачность: со стороны выглядит как «скрытность
        /// иногда не срабатывает», хотя сама она в полном порядке.
        /// </summary>
        public void RefreshVisual()
        {
            if (stealthed) ApplyVisual(true);
        }
